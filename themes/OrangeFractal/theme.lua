--------------------------------------------
-- OrangeFractal theme for the awesome wm --
...
local theme                                     = {}
theme.config_dir                                = os.getenv("HOME") .. "/.config/awesome/themes/OrangeFractal"
theme.wallpaper                                 = theme.config_dir .. "/OrangeFractal.png"
theme.font                                      = "Noto Sans Regular 11"
theme.accent_color                              = "#ff8c00"
--Background color--
...
theme.titlebar_fg_focus                         = theme.accent_color
...
--Hotkey cheatsheet--
theme.hotkeys_font                              = "Noto Sans Bold 10"
...
theme.menu_fg_focus                             = theme.accent_color
...
theme.widget_clock_text                         = "#de5e1e"
theme.widget_date_text                          = "#597ccf"
--Calendar--
...
local mytextclock = wibox.widget {
      {
          {
              widget = wibox.widget.textclock(markup(theme.widget_date_text, "%b %d ") .. markup(theme.widget_clock_text, "%H:%M  ")),
              font = theme.font,
          },
...
--Menus--
theme.mymenu = freedesktop.menu.build({
    before = {
    },
    after = {
        { "Terminal", "alacritty" },
...
--theme.tag_names = { "", "", "", "", "" }
--theme.tag_names = { "Fractal", "Julia set", "Sierpinski triangle", "Jerusalem cube", "Penrose", "Hexaflake", "Mandelbrot set", "8M", "9M" }
--theme.tag_names = { "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹" }
...
theme.tag_layouts = { l.floating, l.tile, l.tile, l.tile, l.tile, l.max, l.max, l.max, l.max }
...
awful.spawn.with_shell("picom --config ~/.config/awesome/themes/OrangeFractal/picom.conf")
