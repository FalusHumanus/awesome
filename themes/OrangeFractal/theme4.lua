...
theme.menu_bg_focus                             = "#050505dd" --Background Focus
			--Hotkey Cheatsheet--
theme.hotkeys_modifiers_fg                      = "#666666" --Text Modkeys
theme.hotkeys_fg                                = "#aaaaaa" --Text Description
