-----------------------------------------
-- SunsetSnow theme for the awesome wm --
...
local theme                                     = {}
theme.config_dir                                = os.getenv("HOME") .. "/.config/awesome/themes/SunsetSnow"
theme.wallpaper                                 = theme.config_dir .. "/GrayGreyLightPinkPastelSunsetMountainLake.png"
theme.font                                      = "Arimo Bold 11"
theme.accent_color                              = "#ffffff"
--Background color--
theme.bg_normal                                 = "#cccccc88"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.myleftwibox = awful.wibar({position = "left", screen = s, height = dpi(1060), width = dpi(24), bg = theme.bg_normal, fg = theme.fg_normal})
    ...
    s.myrightwibox = awful.wibar({position = "right", screen = s, height = dpi(1060), width = dpi(21), bg = theme.bg_normal, fg = theme.fg_normal})
    -- Add widgets to the right wibox
...
awful.spawn.with_shell("picom --config ~/.config/awesome/themes/SunsetSnow/picom.conf")
