...
local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/OrangeFractal"
...
theme.border_normal                             = "#000000" -- "#1c2022"
theme.border_focus                              = "#f36f0e" -- "#5e81ac"
...
local mytextclock = wibox.widget.textclock(markup(--[["#7788af"]]"#597ccf", "%b %d ") .. markup("#de5e1e", "%H:%M "))
